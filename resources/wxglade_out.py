...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sun Nov 17 18:58:09 2019
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.server_hostname = wx.TextCtrl(self.panel_1, wx.ID_ANY, "127.0.0.1", style=wx.TE_PROCESS_ENTER)
        self.server_port = wx.TextCtrl(self.panel_1, wx.ID_ANY, "12345", style=wx.TE_PROCESS_ENTER)
        self.username = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
        self.hostname = wx.TextCtrl(self.panel_1, wx.ID_ANY, "John/127.0.0.1", style=wx.TE_PROCESS_ENTER)
        self.connection_speed = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=["Ethernet", "Dial-up", "64K Modem", "Gigabit"], style=wx.CB_DROPDOWN)
        ...
        self.search_input = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
        self.search_button = wx.Button(self.panel_1, wx.ID_ANY, "Search")
        self.search_output = wx.ListCtrl(self.panel_1, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.search_progress = wx.Gauge(self.panel_1, wx.ID_ANY, 10)
        self.ftp_input = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER)
        self.ftp_button = wx.Button(self.panel_1, wx.ID_ANY, "Execute")
        self.ftp_output = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.TE_READONLY)
    ...
    def __set_properties(self):
        ...
        self.search_output.AppendColumn("Hostname", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.search_output.AppendColumn("Filename", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.search_progress.Enable(False)
        self.search_progress.Hide()
        self.ftp_output.SetFont(wx.Font(9, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_6 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "FTP"), wx.VERTICAL)
        sizer_7 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_4 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "Search"), wx.VERTICAL)
        sizer_5 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_3 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, "Connection"), wx.VERTICAL)
        ...
        sizer_5.Add(self.search_input, 1, wx.ALIGN_CENTER_VERTICAL | wx.BOTTOM | wx.TOP, 5)
...
class ErrorDialog(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        label_8 = wx.StaticText(self, wx.ID_ANY, "Message Here")
