...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sun Nov 17 12:13:23 2019
#
...
class MyFrame(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.search_output.AppendColumn("Speed", format=wx.LIST_FORMAT_LEFT, width=134)
        self.search_output.AppendColumn("Hostname", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.search_output.AppendColumn("Filename", format=wx.LIST_FORMAT_LEFT, width=188)
